	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${pageContext.request.contextPath}">Viajes Informáticos</a>
			</div>
			...
			<s:form name="register" action="register" method="post" role="form">
				<div class="col-md-6 col-md-offset-1">
					...
					<div class="form-group row">
						...
						<div class="checkbox  ">
						<label> <input  name="celular" type="checkbox"> Celular
						</label>
					</div>
				...
				<div class="col-md-4 ">
					<div class="form-group">
						...
						<s:file onchange="PreviewImage();" id="inputFile" name="foto" label="Select a File to upload"
							size="40"  />
